  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          ...
          <li><a href="#"><i class="fa fa-home fa-lg"></i>Products</a></li>
          <li><a href="#"><i class="fa fa-home fa-lg"></i>Services</a></li>
        <li><a href="#"><i class="fa fa-home fa-lg"></i>About Us</a></li>
          <li><a href="#"><i class="fa fa-home fa-lg"></i>Contact Us</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
